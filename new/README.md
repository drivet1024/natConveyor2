...
| `NB_INVERSE_LENGHT_PARCEL` | Colis dont la deuxième mesure positive du dimensionneur dépasse la première d’au moins 2 po |
...
Après trois changements détectés par lecture directe sur un même tag sans notification reçue entre-temps, le contrôle recrée immédiatement la conversation DDE et réabonne tous les tags. Une notification reçue remet ce compteur à zéro ; une lecture directe seule ne le remet pas à zéro. Le message « Surveillance DDE active » confirme l’acceptation de l’abonnement, pas la réception effective de notifications. La reconnexion ne rejoue aucune commande passée.
